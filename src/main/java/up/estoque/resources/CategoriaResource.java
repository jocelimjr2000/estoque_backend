...
public class CategoriaResource extends CustomErrors {
	...
	@GetMapping("/{codigo}")
	@ApiOperation(value = "Pesquisar Categoria")
	public ResponseEntity<Categoria> findById(@PathVariable("codigo") String codigo) {
		try {
			
			Categoria result = categoriaRepository.findByCodigo(codigo);
